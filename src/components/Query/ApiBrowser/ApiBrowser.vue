        ...
        <v-col :lg="vertical ? 12 : 6" cols="12">
          ...
          <v-row>
            <v-col :lg="vertical ? 6 : 12" cols="12">
              <v-btn :disabled="!isValid" :loading="loading" class="mx-0" color="primary" type="submit">Run query
              </v-btn>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapVuexAccessors('queryApiBrowser', ['method', 'stringifiedParams', 'vertical'])
    },
    created () {
