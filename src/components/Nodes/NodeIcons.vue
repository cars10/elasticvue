<template>
  <span>
    ...
    <v-icon v-else-if="elasticsearchNode.masterEligible" title="master eligible" style="width: 24px">mdi-star-bordered</v-icon>
    ...
    <v-icon v-if="elasticsearchNode.coordinatingNode" title="coordinating only node">mdi-transit-connection-variant</v-icon>
  </span>
</template>
