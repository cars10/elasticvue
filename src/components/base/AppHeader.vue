    ...
    <q-toolbar style="height: 64px">
      ...
      <q-tabs stretch>
        <q-route-tab class="full-height" :label="t('base.app_header.navigation.home')" :to="{ name: 'home' }" exact
          :ripple="false" />
        <q-route-tab v-if="!connectionStore.serverless" id="nodes" :label="t('base.app_header.navigation.nodes')"
          :to="{ name: 'nodes' }" :ripple="false" />
        <q-route-tab v-if="!connectionStore.serverless" id="shards" :label="t('base.app_header.navigation.shards')"
          :to="{ name: 'shards' }" :ripple="false" />
        ...
        <q-route-tab v-if="!connectionStore.serverless" :label="t('base.app_header.navigation.snapshots')"
          :to="{ name: 'snapshot_repositories' }" :ripple="false" />
